...
function onScroll(container) {
  ...
  if (currentScrollY2 === scrollTop)
    return;
  previousScrollY2 = currentScrollY2;
  currentScrollY2 = scrollTop;
  if (currentScrollY2 > comparisonScrollY)
    direction = "down";
  else if (currentScrollY2 < comparisonScrollY)
    direction = "up";
...
function scrollama() {
  ...
  S.onStepEnter = (f) => {
    if (typeof f === "function")
      ...
      err2("onStepEnter requires a function");
    return S;
  };
  S.onStepExit = (f) => {
    if (typeof f === "function")
      ...
      err2("onStepExit requires a function");
    return S;
  };
  S.onStepProgress = (f) => {
    if (typeof f === "function")
      ...
      err2("onStepProgress requires a function");
    return S;
  };
  return S;
}
